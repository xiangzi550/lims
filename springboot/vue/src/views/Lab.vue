...
<!--      <el-input style="width: 200px" placeholder="请输入" suffix-icon="el-icon-position" class="ml-5" v-model="address"></el-input>-->
    ...
    <div style="margin: 10px 0">
      ...
      <!-- <el-upload action="http://localhost:9090/lab/import" :show-file-list="false" accept="xlsx" :on-success="handleExcelImportSuccess" style="display: inline-block">
...
<!--      <el-table-column prop="picture" label="实验室照片"></el-table-column>-->
...
export default {
  ...
  methods: {
    ...
    delBatch() {
      ...
      this.request.post("/lab/del/batch", ids).then(res => {
        if (res.code === '200') {

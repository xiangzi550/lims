...
<!--      <el-input style="width: 200px" placeholder="请输入" suffix-icon="el-icon-position" class="ml-5" v-model="address"></el-input>-->
    ...
    <div style="margin: 10px 0">
      ...
      <!-- <el-upload action="http://localhost:9090/faculty/import" :show-file-list="false" accept="xlsx" :on-success="handleExcelImportSuccess" style="display: inline-block">
...
export default {
  ...
  methods: {
    ...
    delBatch() {
      ...
      this.request.post("/faculty/del/batch", ids).then(res => {
        if (res.code === '200') {

...
<!--      <el-input style="width: 200px" placeholder="请输入" suffix-icon="el-icon-position" class="ml-5" v-model="address"></el-input>-->
    ...
    <div style="margin: 10px 0">
      ...
      <!-- <el-upload action="http://localhost:9090/collection/import" :show-file-list="false" accept="xlsx" :on-success="handleExcelImportSuccess" style="display: inline-block">
    ...
    <el-table :data="tableData" border stripe :header-cell-class-name="'headerBg'"  @selection-change="handleSelectionChange">
      ...
      <el-table-column prop="name" label="领用物品名称"></el-table-column>
      <el-table-column prop="person" label="领用人"></el-table-column>
      <el-table-column prop="quantity" label="领用数量"></el-table-column>
...
export default {
  ...
  methods: {
    ...
    exp() {
      window.open("http://localhost:9090/collection/export")
    },

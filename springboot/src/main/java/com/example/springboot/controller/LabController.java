...
public class LabController {
    ...
    public Result save(@RequestBody Lab lab) {
        if (lab.getId() == null) {
            //lab.setTime(DateUtil.now());
            //lab.setUser(TokenUtils.getCurrentUser().getUsername());
        }
...
//        }
    ...
    */
    ...
    public void export(HttpServletResponse response) throws Exception {
        ...
        String fileName = URLEncoder.encode("Lab信息表", "UTF-8");
    ...
    public Result imp(MultipartFile file) throws Exception {
        ...
        List<Lab> list = reader.readAll(Lab.class);

        labService.saveBatch(list);
        return Result.success();
    }

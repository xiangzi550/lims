...
public class CollectionController {
    ...
    public Result save(@RequestBody Collection collection) {
        if (collection.getId() == null) {
            ...
            //collection.setUser(TokenUtils.getCurrentUser().getUsername());
        }
...
//        }
    ...
    */
    ...
    public void export(HttpServletResponse response) throws Exception {
        ...
        String fileName = URLEncoder.encode("Collection信息表", "UTF-8");
    ...
    public Result imp(MultipartFile file) throws Exception {
        ...
        List<Collection> list = reader.readAll(Collection.class);

        collectionService.saveBatch(list);
        return Result.success();
    }

...
public class CodeGenerator {
    ...
    // 数据库名称
    private static final String DATASOURCE = "cs";
    
    // 你自己的项目路径，一定要改成你自己的！！结尾必须是:  \\springboot\\
    private static final String basePath = "D:/Project/springboot/";

    // 数据库需要生成代码的表名
    private static final String tableName = "sys_buyer" ;
    // 生成页面的菜单名称
    private static final String modelName = "采购员信息";
